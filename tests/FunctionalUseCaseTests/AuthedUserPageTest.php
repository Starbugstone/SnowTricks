...
class AuthedUserPageTest extends WebTestCase
{
    ...
    public function testCRUD()
    {
        ...
        $form = $crawler->selectButton('trick_type_form_save')->form();

        $form['trick_type_form[name]'] = $this->dummyTitle;
        $form['trick_type_form[text]'] = $this->dummyText;
        ...
        $form = $crawler->selectButton('trick_type_form[save]')->form();
        $form['trick_type_form[name]'] = $this->dummyTitleEdit;
        $form['trick_type_form[text]'] = $this->dummyTextEdit;
