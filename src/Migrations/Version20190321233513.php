 ...
 */
final class Version20190321233513 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE image ADD updated_at DATETIME NOT NULL, CHANGE trick_id trick_id INT DEFAULT NULL, CHANGE title title VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE image DROP updated_at, CHANGE trick_id trick_id INT DEFAULT NULL, CHANGE title title VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
