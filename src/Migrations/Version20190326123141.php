 ...
 */
final class Version20190326123141 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE image ADD primary_image TINYINT(1) NOT NULL, CHANGE trick_id trick_id INT DEFAULT NULL, CHANGE title title VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE image DROP primary_image, CHANGE trick_id trick_id INT DEFAULT NULL, CHANGE title title VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
