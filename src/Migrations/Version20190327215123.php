 ...
 */
final class Version20190327215123 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE video_type CHANGE code code LONGTEXT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE video CHANGE trick_id trick_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE video_type CHANGE code code VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
